	...
	<head>
		...
		<div class="viewFrameWork-body">
			...
			<div class="row" style="height:60px">
				<div class="col-md-6"><h3 style="margin-left: 50px;">编辑考试</h3></div>
				<div class="col-md-6" ><button class="btn btn-default" id="saveBtn" style="float:right;margin-right: 60px;margin-top: 15px;">保存修改</button></div>"
			</div>
											...
											<div class="panel panel-default panel-paper" id="paperPanel">
												<div class="panel-heading clearfix">
													<div class="paper-title">
														<span class="paper-name">高数</span>
														<span class="paper-type">(选题组卷)</span>
													</div>
												...
												<div class="panel-body">
													<div class="form-row">
														...
														<span class="content paper-total-score">2.0</span>
													</div>
													<div class="form-row">
														<span class="title">创建人:</span>
														<span class="content paper-create-user-name">sum</span>
													</div>
													<div class="form-row">
														<span class="title">试题数量:</span>
														<span class="content paper-test-count">1</span>
													</div>
													<div class="form-row">
														<span class="title">创建日期:</span>
														<span class="content paper-created-time">2018-04-10 13:43:20</span>
													</div>
													<div class="text-center">

														<button type="button" class="btn btn-default changePaper" id="selPaperLink">更换试卷</button>
