            ...
            <form role="form" action="#" method="post">
                ...
                <fieldset id = "fieldset" disabled="disabled">
                    <div class="form-group" id="nickName">
                        ...
                        <input type="text" class="form-control" id="inputSuccess1" name="sname" value="小明明"
                               data-toggle="toggle" title= "昵称3-16位，可以为汉字、数字、字母（大小写）、下划线" >
                    </div>
                    <div class="form-group" id="telephone">
                        <label for="contact-inf">联系方式</label>
                        <input type = "text" id = "contact-inf" class="form-control" name="phone" value="12345678941"
                               data-toggle="toggle" title= "抱歉，只能输入您11位的手机号码">
                    </div>
                    <div class="form-group" id = "myEmail">
                        <label for="email">邮箱</label>
                        <input type = "email" id = "email" name="email" class="form-control" value="1604452143@qq.com"
                               data-toggle="toggle" title= "请输入合法的邮箱地址">
                    </div>
                    <div class="radio">
                        <label>
                            <input type="radio" name="sex" id="sexRadio1" value="男" checked > 
                            男
                        </label>
                        <label>
                    ...
                    <div class= "form-group">
                        ...
                        <div class="controls input-append date form_datetime"
                            ...
                            <input type="text" name="birthday" class="form-control" value="2018-06-17" readonly>
