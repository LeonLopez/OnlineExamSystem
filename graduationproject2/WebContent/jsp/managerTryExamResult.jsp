	...
	<body>
		...
		<div class="main">
			<div class="header-wrapper">
				...
				<a type="button" class="btn btn-default logout" href="${pageContext.request.contextPath}/managerTryExam.action?id=${examid}">
			...
			<div class="body-wrapper">
				...
				<div class="footer-wrapper clearfix footer-tab-1">
					...
					<div class="tab-btn">
						<a type="button" class="btn btn-primary" href="${pageContext.request.contextPath}/managerTryExam.action?id=${examid}">再考一次</a>
					</div>
